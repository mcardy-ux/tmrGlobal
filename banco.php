        ...
        <div class="row ">
            ...
            <div class="col-lg-6">
                <div class="section-title left-align wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                    ...
                    Nuestros técnicos especialistas Bielorrusos quienes poseen experiencia alrededor del mundo, en programación y actualización de software para Bancos de Prueba, han culminado la modernización de nuestro sistema del banco para motores TV3-117 Series, dejándolo con la ultima tecnología de punta.
                    </p>
                </div>
