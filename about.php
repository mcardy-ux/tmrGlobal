            ...
            <div class=col-lg-6>
                <div class="image_box relative z-1 text-center about_me">
                    ...
                    <div class="progress_box grid wow fadeInDown" style=visibility:visible;animation-name:fadeInDown>
                        ...
                        <div class=text>
                            <h5 class=mb-0>Profesionalidad y<br>
                                Calidad</h5>
                        </div>
                    </div>
            ...
            <div class="col-xl-5 col-lg-6 mb-md-80">
                <div class="section-title left-align wow fadeInUp">
                    ...
                    <p class=mb-0 style=font-size:18px>
                        Las instalaciones del taller fueron diseñadas de acuerdo con los requisitos técnicos y tecnológicos establecidos por los fabricantes de motores. 
                        <br><br>
                        TMR SAS se encuentra localizada en el Aeropuerto Internacional El Dorado, Nueva Zona de Aviación General, Hangar 19, Bogotá – Colombia.
                    </p>
                </div>
