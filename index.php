...
<div class=container>
    <div class="row space-row">
        <div class="col-xl-12 col-lg-12 relative  z-1 ">


            <div class="banner_text_header ">
                <h2 class="page_title animate__animated animate__bounceIn animate__slower">Bienvenido a TMR </h2>
                <div class=" banner_text_header col-xl-8 col-lg-8 col-md-8 relative  z-1 " style="margin: 0 auto">
                    <hr class="horizontal_index">
                    <h4 class="page_title_parragraph  animate__animated animate__shakeY animate__slower">Mantenimiento y reparación de motores TV3-117 Series, AI-9V y sus accesorios</h4>
                </div>
                <br>
                <br>
...
<div class="section-padding pt-0" id="commitment"></div>
<div class=container>
    <div class=row>
...
<div class="section-padding pt-0" id="testBench"></div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
                    ...
                    <h3 class="title" style="text-transform: initial;">Banco de Prueba de Motores TV3-117 Series </h3>
                </div>
            </div>
        </div>
        <div class="row ">
